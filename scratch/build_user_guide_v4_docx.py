"""
Generates USER_GUIDE_(UPDATED)V4.docx from the eight user-guide markdown files
served by the PSAT Help page (Documentation & Guides > User Guide tab).
"""
...
DOCS_DIR = Path(__file__).parent.parent / "frontend" / "public" / "docs" / "user"
OUTPUT   = Path(__file__).parent.parent / "USER_GUIDE_(UPDATED)V4.docx"
...
def build_doc():
    ...
    title_run = title_para.add_run("PSAT User Guide")
    title_run.bold = True
    ...
    sub_run = sub_para.add_run("CycleRAP v2.11  ·  Version 4  (Updated June 2026)")
