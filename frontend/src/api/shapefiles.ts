...
/**
 * POST /api/shapefiles/metadata — override the displayed "Required Columns" /
 * "Affects" metadata for a layer. This only corrects the informational labels
 * shown in the GIS Layers list — it does not change what columns the scoring
 * engine reads.
 */
