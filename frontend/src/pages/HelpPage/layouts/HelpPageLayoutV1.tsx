...
import type { HelpPageViewModel } from "./HelpPageViewModel";

export default function HelpPageLayoutV1({ activeTab, setActiveTab, onBack }: HelpPageViewModel) {
    ...
    <Box minH="100vh" bg="gray.100" _dark={{ bg: "gray.900" }} p={{ base: "4", md: "6" }} fontFamily="inherit">
      ...
      >
        ...
        >
          ...
          <Button size="sm" colorPalette="blue" onClick={onBack}>
            Go Back
          </Button>
        </Flex>
