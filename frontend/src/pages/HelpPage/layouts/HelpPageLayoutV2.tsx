...
const DOC_LISTS: Record<HelpTab, DocItem[]> = {
  ...
  developer: [
    ...
    { id: "treatments",   num: 7,  title: "Treatment Config",  path: "/docs/developer/treatments.md",         updatedDate: "Jun 2026" },
    { id: "frontend",     num: 8,  title: "Frontend",          path: "/docs/developer/frontend.md",           updatedDate: "Jun 2026" },
    { id: "issues",       num: 9,  title: "Common Issues",     path: "/docs/developer/common-issues.md",      updatedDate: "Jun 2026" },
    { id: "contributing", num: 10, title: "Contributing",      path: "/docs/developer/contributing.md",       updatedDate: "Jun 2026" },
    { id: "jira",         num: 11, title: "Jira Board",        path: "/docs/developer/dev-jira.md",           updatedDate: "Jun 2026" },
    { id: "gradient",     num: 12, title: "Gradient Data",     path: "/docs/developer/gradient-data.md",      updatedDate: "Aug 2026" },
    { id: "platform",     num: 13, title: "Platform Compatibility", path: "/docs/developer/platform-compatibility.md", updatedDate: "Aug 2026" },
    { id: "gis",          num: 14, title: "GIS Attributes",    path: "/docs/developer/gis/README.md",         updatedDate: "Aug 2026" },
    { id: "deploy-remote",  num: 15, title: "Remote Updates",       path: "/docs/developer/how-to-update-remotely.md",           updatedDate: "Aug 2026" },
    { id: "deploy-ops",     num: 16, title: "Deployment Ops Guide", path: "/docs/developer/deployment-operations-guide.md",      updatedDate: "Aug 2026" },
    { id: "deploy-update",  num: 17, title: "Shipping an Update",   path: "/docs/developer/deployment-updating-guide.md",         updatedDate: "Aug 2026" },
    { id: "deploy-history", num: 18, title: "Deployment Decisions", path: "/docs/developer/deployment-decisions-and-history.md", updatedDate: "Aug 2026" },
    { id: "cyclerap-audit", num: 19, title: "CycleRAP v2.13 Audit (superseded)", path: "/docs/developer/cyclerap_v213_audit.md", updatedDate: "Jul 2026" },
  ],
};
