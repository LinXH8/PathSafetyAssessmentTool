...
/**
 * Per-attribute → per-value color map + resolver. MOVED to the canonical map-color
 * source of truth (`constants/mapColors.ts`) as the base for v2. Re-exported here so
 * existing `from "./AttributesDropdown"` imports keep working unchanged.
 */
export { CATEGORY_COLORS, getCategoryColor } from "../../../constants/mapColors";
